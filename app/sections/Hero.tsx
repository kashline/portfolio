    ...
    <section id="top" className="relative pt-32 pb-24 sm:pt-40 sm:pb-32">
      ...
      <div className="flex items-center justify-between gap-8">
        ...
        <div className="hidden sm:flex shrink-0 justify-end">
          <Image src={'/kevin_city.jpg'} width={420} height={820} alt="From this image alone you can tell this is an exceptional engineer." className="rounded-xl object-cover" />
        </div>
      </div>
    </section>
  );
